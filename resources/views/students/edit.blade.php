            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('students.update', $student->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="enrollment_year" id="enrollment_year" min="1900" max="{{ date('Y') }}" value="{{ old('enrollment_year', $student->enrollment_year) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="flex justify-end">
                        ...
                        <button type="submit"
                            class="bg-blue-600 text-gray-700 px-4 py-2 rounded hover:bg-blue-700">Update Student</button>
                    </div>
                </form>
            </div>
        </div>
